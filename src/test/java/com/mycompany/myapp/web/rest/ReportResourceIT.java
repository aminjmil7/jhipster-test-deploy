...
class ReportResourceIT {
    ...
    public static Report createEntity(EntityManager em) {
        Report report = new Report().mail(DEFAULT_MAIL).message(DEFAULT_MESSAGE);
        return report;
    }
    ...
    public static Report createUpdatedEntity(EntityManager em) {
        Report report = new Report().mail(UPDATED_MAIL).message(UPDATED_MESSAGE);
        return report;
    }
    ...
    void putNewReport() throws Exception {
        ...
        updatedReport.mail(UPDATED_MAIL).message(UPDATED_MESSAGE);
    ...
    void fullUpdateReportWithPatch() throws Exception {
        ...
        partialUpdatedReport.mail(UPDATED_MAIL).message(UPDATED_MESSAGE);
