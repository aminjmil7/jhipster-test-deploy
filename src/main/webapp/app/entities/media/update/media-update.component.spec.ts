  ...
  describe('Media Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call Park query and add missing value', () => {
        ...
        const park: IPark = { id: 82592 };
        media.park = park;

        const parkCollection: IPark[] = [{ id: 15554 }];
      ...
      it('Should call Report query and add missing value', () => {
        const media: IMedia = { id: 456 };
        const report: IReport = { id: 82716 };
        media.report = report;

        const reportCollection: IReport[] = [{ id: 25937 }];
